...
const RESEARCH_SECTIONS = [
  ...
  "technology and digital transformation: the company's current IT landscape and core systems; whether there is a plan or clear need for digital transformation given its business outlook; the latest technologies it could leverage to improve business and operational efficiency; and what its competitors are leveraging from a technology perspective",
...
For the Technology Maturity Assessment, score the company 1-5 on the 4-6 digital
dimensions most relevant to its business (e.g. Cloud Adoption, AI Readiness,
Automation, Analytics, CRM Maturity, Cybersecurity), give a one-line rationale for
each, and compute an overall score (average, to one decimal, as "X/5").

End with 3-5 Executive Recommendations / Next Best Actions: each prioritized
(High/Medium/Low) with a specific, actionable recommendation and its expected
business impact — tailored to this company's situation and challenges.

For financial figures (revenue, funding, etc.), give a SINGLE best estimate, not
a wide range. Prefer the most recent reported or widely-cited figure with its
year, e.g. "~$650M (FY2025)". If it must be approximate, round to one clean
number prefixed with "~". Never output a broad span like "$264M to $700M" — pick
the most credible single value.
